function [time,waveform] = symbolsToWaveform2(symbols, rate_sym, rate_samp, fc, bw, beta)
% symbolsToWaveform is the central function of Binary_To_QAM_Waveform.
% This function takes a vector of symbol values, and returns a
% time-domain waveform sampled at the sepcified symbol rate
...
%% Set the sample rate
% The "upsample" function requires an integer number of samples to insert
% between symbol values.
...
waveform = interp1(t_up_int, S3_pulseshape, t_interp, 'spline');
time = t_interp;
